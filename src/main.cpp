...
##################################################
## Código feito por Artur Sarlo(artur.sarlo@la.logicalis.com) 
## Código modificado por Luiz Henrique (luizhfmonteiro@gmail.com) para 
...
void EnviarDados(void){
  ...
  payload.replace("schema_name", "alluna12");
  payload.replace("field0", "field1");
  payload.replace("pl", "checkin");
  payload.replace("field1", "field1");
  payload.replace("pl", "checkout");
  payload.replace("field2", "field1");
  payload.replace("pl", "vaitomanocu");
  payload.replace("field3", "field1");
  payload.replace("pl", "vaitomanocu");
  //payload.replace("field1", "horario");
 // payload.replace("field1_value", "world");
